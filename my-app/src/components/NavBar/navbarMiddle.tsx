    ...
    return (
        <div className="flex basis-3/4">
            <nav onClick={() => setMenuOpen(prev => !prev)} className="transition-all duration-300 ease-in-out w-1/3 lg:w-0 flex items-center justify-center touch-manipulation">
                <Image width={15} height={15}  className="w-6 h-6" src="/Components/NavBar/menu.png" alt="Menu" />
            </nav>
            <div
                className={`
            ...
            <nav className="w-2/3 rounded-r-xl flex items-center justify-center overflow-hidden">
                <Image width={260} height={60} src="/Components/NavBar/Logo_Brno_BLACK_RGB.png" alt="Logo_Brno_BLACK_RGB" />
            </nav>
            <nav className="flex flex-row transition-all duration-500 ease-in-in w-0 lg:w-full overflow-y-hidden">
